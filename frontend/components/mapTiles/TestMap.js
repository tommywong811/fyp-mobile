...
function mapDispatchToProps(dispatch){
    return {
        change_currX: (x) => dispatch({type: CHANGE_CURRX, payload: {currX: x}}),
        change_currY: (y) => dispatch({type: CHANGE_CURRY, payload: {currY: y}}),
        change_sumX: (sumx) => dispatch({type: CHANGE_SUMX, payload: {sumX: sumx}}),
        change_sumY: (sumy) => dispatch({type: CHANGE_SUMY, payload: {sumY: sumy}})
    };
}
